...
public class ImagePopupDialog extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        menuImageFetcher = new MenuImageFetcher();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // start async fetch
        menuImageFetcher.fetchImage(requireActivity(), vendorId, popupImage, placeholder);
    ...
    public void onDestroyView() {
        super.onDestroyView();
        menuImageFetcher.cancel(); // cancel if fragment is destroyed
